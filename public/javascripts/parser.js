...
parser.createRowEventTable = function(JSON){
	...
	$('#eventsTable tr:last').after("<tr><td>" + JSON.typeOfSport + "</td><td>" + JSON.date + "</td><td><a href='people_list.html' target='_blank'><span class='glyphicon glyphicon-eye-open'></span></a></td></tr>");
}
